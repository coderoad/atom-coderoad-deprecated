...
var default_1 = (function (_super) {
    ...
    default_1.prototype.menuOptions = function () {
        ...
        switch (this.props.route) {
            case 'final':
            case 'page':
                return (React.createElement("div", null, React.createElement(menu_item_1.default, {primaryText: 'progress', onTouchTap: routeToProgress, key: 'progress'}), React.createElement(menu_item_1.default, {primaryText: 'tutorials', onTouchTap: routeToTutorials, key: 'projects'})));
            case 'progress':
                return React.createElement(menu_item_1.default, {primaryText: 'tutorials', onTouchTap: routeToTutorials, key: 'projects'});
            default: return null;
        }
    };
