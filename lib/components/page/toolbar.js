...
var default_1 = (function (_super) {
    ...
    default_1.prototype.render = function () {
        ...
        return (React.createElement("section", {className: 'cr-page-toolbar'}, React.createElement(ProgressBar, {progress: progress}), React.createElement(material_ui_1.Toolbar, null, React.createElement(material_ui_1.ToolbarGroup, {float: 'left'}, React.createElement(material_ui_1.FlatButton, {label: 'Log', onTouchTap: editor_1.toggleDevTools})), React.createElement(material_ui_1.ToolbarGroup, {float: 'right'}, this.getButton()))));
    };
