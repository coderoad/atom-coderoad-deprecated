        ...
        react_redux_1.connect(null, function (dispatch) {
            return {
                tutorialsFind: function () {
                    dispatch(_actions_1.tutorialsFind());
                }
            };
        }), 
        ...
        react_redux_1.connect(null, function (dispatch) {
            return {
                tutorialUpdate: function (name) {
                    dispatch(_actions_1.tutorialUpdate(name));
                }
            };
        }), 
        __metadata('design:paramtypes', [])
        ...
        react_redux_1.connect(null, function (dispatch) {
            return {
                selectTutorial: function (tutorial) {
                    ...
                    dispatch(_actions_1.tutorialSet());
                    dispatch(_actions_1.positionSet({ chapter: 0, page: 0 }));
                    dispatch(_actions_1.setRoute('progress'));
                },
            };
        }), 
        __metadata('design:paramtypes', [])
