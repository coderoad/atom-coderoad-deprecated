...
var TutorialList = (function (_super) {
    ...
    TutorialList.prototype.render = function () {
        ...
        }))), React.createElement("br", null), React.createElement(flat_button_1.default, {style: { margin: '0 90px' }, label: 'Check for Tutorials', secondary: true, onTouchTap: loadTutorials})));
    };
