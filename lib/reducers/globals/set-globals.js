...
function setGlobals(packageJson) {
    return Object.assign({}, {
        ...
        tutorialDir: path_1.join(window.coderoad.dir, 'node_modules', packageJson.name, packageJson.config.testDir),
...
function loadRunnerDep(packageJson) {
    var flatDep = path_1.join(window.coderoad.dir, 'node_modules', packageJson.config.testRunner, 'package.json');
    var treeDep = path_1.join(window.coderoad.dir, 'node_modules', packageJson.name, 'node_modules', packageJson.config.testRunner, 'package.json');
    var runnerMain;
    var runnerRoot;
